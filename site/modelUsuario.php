...
class modelUsuario 
{
    ...
    function criarSuperUser($conDb)
    {
        ...
        if ( $rs->QTD == 0 ) {
            ...
            $rsUsuario = $conDb->db_insert( "INSERT INTO usuario
           ...
           if ( $rsUsuario > 0 ) {
               ...
               echo "Falha na inclusão do super usuário"; exit;
           }
    ...
    function buscaLogin($conDb, $userName)
    {
        ...
        $rsc = $conDb->db_select( "SELECT * FROM usuario WHERE Login = ?", 
                                  array($userName) );
    ...
    function buscaUsuarioID($conDb, $CodUsuario)
    {
        ...
        $modelRsc = $conDb->db_select( "SELECT * FROM usuario WHERE CodUsuario = ?", 
                                  array($CodUsuario) );
    ...
    function insert($conDb, $data) 
    {
        ...
        $rs = $conDb->db_insert( "INSERT INTO usuario
    ...
    function update($conDb, $data) 
    {
        ...
        $rs = $conDb->db_update( "UPDATE usuario
