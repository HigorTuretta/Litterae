          ...
          <div class="row">
            ...
            <div class="col-sm-12">
              <div class="form-group">
                <input class="form-control" name="Login" id="Login" type="text" placeholder="Informe o login" required>
              </div>
            </div>
            <div class="col-sm-12">
              <div class="form-group">
                <input class="form-control" name="Senha" id="Senha" type="password" placeholder="Sua senha" required>
              </div>
            </div>
          </div>
